...
import { CheckmarkFilled24, ChevronRight16 } from "@carbon/icons-react";
      ...
      <section className="services">
        <div className="wrap">
          ...
          <p style={{ fontSize: "2rem" }}>
            Get instant price using our latest online booking system. Save time
            save money. Travel better.
            <br />
            We offer a very flexible pricing structure to meet the needs of all
            types of customers.
          </p>
              ...
              <>
                <ul class="plan-points">
                  ...
                  <li className="point">
                    ...
                    8 Hours (1 Day) AED 500
                  </li>
                  <li className="point">
                    <i>
                      <CheckmarkFilled24 />
                    </i>
                    16 Hours (2 Days) AED 1000
                  </li>
                  <li className="point">
                    <i>
                      <CheckmarkFilled24 />
                    </i>
                    24 Hours (3 Days) AED 1500
                  </li>
                </ul>
              </>
              <a
            ...
            <div className="price-plan active">
              ...
              <ul class="plan-points">
                <li className="point">
                  ...
                  Dubai <ChevronRight16 /> Abu Dhabi AED 440
                </li>
                <li className="point">
                  <i>
                    <CheckmarkFilled24 />
                  </i>
                  Dubai <ChevronRight16 /> Sharjah AED 160
                </li>
                <li className="point">
                  <i>
                    <CheckmarkFilled24 />
                  </i>
                  Dubai <ChevronRight16 /> Ajman AED 210
                </li>
                <li className="point">
                  <i>
                    <CheckmarkFilled24 />
                  </i>
                  Dubai <ChevronRight16 /> UAQ AED 240
                </li>
                <li className="point">
                  <i>
                    <CheckmarkFilled24 />
                  </i>
                  Dubai <ChevronRight16 /> Rak AED 400
                </li>
                <li className="point">
                  <i>
                    <CheckmarkFilled24 />
                  </i>
                  Dubai <ChevronRight16 /> Fujairah AED 400
                </li>
                <li className="point">
                  <i>
                    <CheckmarkFilled24 />
                  </i>
                  Dubai <ChevronRight16 /> Al Ain AED 400
                </li>
              </ul>
              <a
                href={`https://wa.me/${phone}?text=hello, I would like to book a safe driver.`}
